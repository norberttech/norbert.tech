...
final class Posts
{
    private array $posts = [
        ...
        [
            'id' => 17,
            'title' => 'The Dark Sides of Modularization',
            'labels' => ['modularization', 'architecture', 'software development'],
            'description' => 'Practical challenges of system modularization - how to solve database-level coupling when extracting a module from a monolith. Comparing approaches: separation of responsibilities, projections, anemic events, and materialized views.',
            'slug' => 'dark-sides-of-modularization',
            'language' => 'en',
            'date' => '2025-10-18',
        ...
        [
            'id' => 18,
            'title' => 'Die dunklen Seiten der Modularisierung',
            'labels' => ['Modularisierung', 'Architektur', 'Softwareentwicklung'],
            'description' => 'Praktische Herausforderungen der Systemmodularisierung - wie man Kopplungen auf Datenbankebene löst, wenn ein Modul aus einem Monolithen extrahiert werden muss. Vergleich der Ansätze: Trennung der Verantwortlichkeiten, Projektionen, anemische Events und Materialized Views.',
            'slug' => 'die-dunklen-seiten-der-modularisierung',
            'language' => 'de',
            'date' => '2025-10-18',
        ...
        [
            'id' => 19,
            'title' => 'Los Lados Oscuros de la Modularización',
            'labels' => ['modularización', 'arquitectura', 'desarrollo de software'],
            'description' => 'Desafíos prácticos de la modularización de sistemas - cómo resolver el acoplamiento a nivel de base de datos al extraer un módulo de un monolito. Comparación de enfoques: separación de responsabilidades, proyecciones, eventos anémicos y vistas materializadas.',
            'slug' => 'los-lados-oscuros-de-la-modularizacion',
            'language' => 'es',
            'date' => '2025-10-18',
        ...
        [
            'id' => 20,
            'title' => 'Les Côtés Sombres de la Modularisation',
            'labels' => ['modularisation', 'architecture', 'développement logiciel'],
            'description' => 'Défis pratiques de la modularisation des systèmes - comment résoudre le couplage au niveau de la base de données lors de l\'extraction d\'un module d\'un monolithe. Comparaison des approches : séparation des responsabilités, projections, événements anémiques et vues matérialisées.',
            'slug' => 'les-cotes-sombres-de-la-modularisation',
            'language' => 'fr',
            'date' => '2025-10-18',
        ...
        [
            'id' => 21,
            'title' => 'I Lati Oscuri della Modularizzazione',
            'labels' => ['modularizzazione', 'architettura', 'sviluppo software'],
            'description' => 'Sfide pratiche della modularizzazione dei sistemi - come risolvere l\'accoppiamento a livello di database durante l\'estrazione di un modulo da un monolite. Confronto degli approcci: separazione delle responsabilità, proiezioni, eventi anemici e viste materializzate.',
            'slug' => 'i-lati-oscuri-della-modularizzazione',
            'language' => 'it',
            'date' => '2025-10-18',
        ...
        [
            'id' => 22,
            'title' => 'Telemetria w PHP',
            'labels' => ['telemetria', 'PHP', 'observability'],
            'description' => 'Wpis o telemetrii i observability w aplikacjach PHP.',
            'slug' => 'flow-php-telemetry',
            'language' => 'pl',
            'date' => '2026-03-01',
            'translations_ids' => [23, 24, 25, 26, 27],
            'hero_img_src' => 'images/blog/php-telemetry/pipes.jpg',
        ],
        [
            'id' => 23,
            'title' => 'Flow PHP - Telemetry',
            'labels' => ['telemetry', 'PHP', 'observability'],
            'description' => 'A lightweight telemetry library for PHP that plays nice with OpenTelemetry without the dependency bloat and global state.',
            'slug' => 'flow-php-telemetry-en',
            'language' => 'en',
            'date' => '2026-03-01',
            'translations_ids' => [22, 24, 25, 26, 27],
            'translated' => true,
            'hero_img_src' => 'images/blog/php-telemetry/pipes.jpg',
        ],
        [
            'id' => 24,
            'title' => 'Flow PHP - Télémétrie',
            'labels' => ['télémétrie', 'PHP', 'observabilité'],
            'description' => 'Une bibliothèque de télémétrie légère pour PHP, compatible avec OpenTelemetry sans surcharge de dépendances.',
            'slug' => 'flow-php-telemetrie',
            'language' => 'fr',
            'date' => '2026-03-01',
            'translations_ids' => [22, 23, 25, 26, 27],
            'translated' => true,
            'hero_img_src' => 'images/blog/php-telemetry/pipes.jpg',
        ],
        [
            'id' => 25,
            'title' => 'Flow PHP - Telemetria',
            'labels' => ['telemetria', 'PHP', 'osservabilità'],
            'description' => 'Una libreria di telemetria leggera per PHP, compatibile con OpenTelemetry senza sovraccarico di dipendenze.',
            'slug' => 'flow-php-telemetria',
            'language' => 'it',
            'date' => '2026-03-01',
            'translations_ids' => [22, 23, 24, 26, 27],
            'translated' => true,
            'hero_img_src' => 'images/blog/php-telemetry/pipes.jpg',
        ],
        [
            'id' => 26,
            'title' => 'Flow PHP - Telemetría',
            'labels' => ['telemetría', 'PHP', 'observabilidad'],
            'description' => 'Una biblioteca de telemetría ligera para PHP, compatible con OpenTelemetry sin sobrecarga de dependencias.',
            'slug' => 'flow-php-telemetria-es',
            'language' => 'es',
            'date' => '2026-03-01',
            'translations_ids' => [22, 23, 24, 25, 27],
            'translated' => true,
            'hero_img_src' => 'images/blog/php-telemetry/pipes.jpg',
        ],
        [
            'id' => 27,
            'title' => 'Flow PHP - Telemetrie',
            'labels' => ['Telemetrie', 'PHP', 'Observability'],
            'description' => 'Eine leichtgewichtige Telemetrie-Bibliothek für PHP, kompatibel mit OpenTelemetry ohne Abhängigkeitsüberlastung.',
            'slug' => 'flow-php-telemetrie-de',
            'language' => 'de',
            'date' => '2026-03-01',
            'translations_ids' => [22, 23, 24, 25, 26],
            'translated' => true,
            'hero_img_src' => 'images/blog/php-telemetry/pipes.jpg',
        ],
    ];
